...
int main() {
    ...
    cout << "Введите a (начало интервала): ";
    cin >> a;
    cout << "Введите b (конец интервала): ";
    cin >> b;
    cout << "Введите h (шаг): ";
    cin >> h;
    ...
    cout << "Таблица значений котангенса на интервале [" << a << ", " << b << "] с шагом " << h << ":" << endl;
    for (double x = a; x <= b; x += h) {
        if (sin(x) == 0) {
            cout << "x = " << x << "; котангенс не определен (sin(x) = 0)" << endl;
        }
        else {
